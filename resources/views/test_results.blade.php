...
@section('body')
        ...
        <table class="table is-fullwidth is-striped">
            <thead>
                <tr>
                    <th colspan="2" class="has-text-centered">Domain Events</th>
                </tr>
            </thead>
            @if($rdp)
            <tbody>  <tr>
                    <th>Registration Date</th>
                    <td>{{ $registertration }}</td> </tr>
                <tr>
            ...
            @else
            <tbody>
                <tr><td><bold>This Domain Doesn't support RDAP</bold></td></tr>
            </tbody>
            @endif
